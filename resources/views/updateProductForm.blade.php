...
@section('sadrzajStranice')
    ...
    <div class="container mb-3">
        <div class="col-6">
            <form action="{{ route('updateProduct', ['product' => $singleProduct->id]) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="file" class="form-label">Cena</label>
                        <input type="file" id="file" class="form-control" name="image" value="{{ $singleProduct->price }}">
                    </div>
